...
public class CaretakerController {
    ...
    public ResponseEntity<CaretakerCaregiverDTO> addCaregiver(@PathVariable Long caretakerId,
    ...
    public ResponseEntity<Map<String, String>> deleteCaregiver(@PathVariable Long caretakerId,
                                                               @PathVariable Long caregiverId) {
    ...
    public ResponseEntity<List<RecordDTO>> getRecordsByDate(
        ...
        List<RecordDTO> records = userMedicationService.getUserMedicationRecordsByDate(caretakerId,
                date.atStartOfDay());
